...
export default function AllReviewsPage() {
  ...
  const [selectedRange, setSelectedRange] = useState<"Last 7 days" | "Last 30 days" | "Quarter to date" | "Show all reviews">("Last 30 days");
            ...
            <div className="w-full overflow-auto flex-1 space-y-3 pb-6 min-h-0">
              {(() => {
                ...
                return filtered.map((r) => (
                  <article key={r.docId} className="space-y-2 rounded-xl bg-white p-4 shadow-sm">
